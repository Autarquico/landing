          ...
          <div className="container mx-auto px-4 md:px-6 lg:px-12 text-center">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
              <a
                ...
                className="group block bg-white dark:bg-neutral-800 rounded-2xl p-8 border border-gray-100 dark:border-neutral-700 hover:border-emerald-500 transition-colors"
              >
                <p className="font-display text-4xl mb-2">δ</p>
                <p className="font-display text-xl mb-2">delta</p>
              ...
              <a
                ...
                className="group block bg-white dark:bg-neutral-800 rounded-2xl p-8 border border-gray-100 dark:border-neutral-700 hover:border-emerald-500 transition-colors"
              >
                <p className="font-display text-4xl mb-2">σ</p>
                <p className="font-display text-xl mb-2">sigma</p>
